...
let standard_library_default = "/Users/bsansouci/Desktop/bs-platform-native/native/4.06.1/lib/ocaml"
...
let standard_runtime = "/Users/bsansouci/Desktop/bs-platform-native/native/4.06.1/bin/ocamlrun"
let ccomp_type = "cc"
let c_compiler = "gcc"
let c_output_obj = "-o "
...
let mkdll, mkexe, mkmaindll =
  ...
  if Sys.os_type = "Win32" then
    try
      ...
      flexlink ^ " -maindll"
    with Not_found ->
      "gcc -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind", "gcc -O2 -fno-strict-aliasing -fwrapv -Wall -D_FILE_OFFSET_BITS=64 -DCAML_NAME_SPACE   -Wl,-no_compact_unwind", "gcc -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind"
  else
    "gcc -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind", "gcc -O2 -fno-strict-aliasing -fwrapv -Wall -D_FILE_OFFSET_BITS=64 -DCAML_NAME_SPACE   -Wl,-no_compact_unwind", "gcc -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind"
...
let host = "x86_64-apple-darwin19.4.0"
let target = "x86_64-apple-darwin19.4.0"
